...
// var width = Math.max(window.screen.width, window.innerWidth);
    ...
    imgf116.onclick = function(e){
        if(width.matches){
            modal0116.classList.add('open');
            } else {
            return;
            }      }
    imgf117.onclick = function(e){
        if(width.matches){
            modal0117.classList.add('open');
            } else {
            return;
            }     
    }
